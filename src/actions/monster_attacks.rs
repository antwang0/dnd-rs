...
/// Greataxe — STR-based 1d12 slashing melee, reach 1. Standard 5e
/// orc weapon. Higher max damage than scimitar (1d6) but the same
/// reach, so it's the orc's signature one-swing-then-charge tool.
pub struct Greataxe {}
