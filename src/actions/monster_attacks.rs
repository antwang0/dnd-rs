...
impl Action for TripAttack {
    ...
    fn side_effects(
        ...
        let mut effects = resolve_d20_attack(
            encounter,
            caster_id,
            target_id,
            self.name(),
        ...
        // resolve_d20_attack returns empty Vec on miss — only roll the save if
...
impl Action for AcidSpit {
    ...
    fn side_effects(
        ...
        // Primary attack — reuse resolve_d20_attack so logging matches other
        // attacks. resolve_d20_attack returns Vec containing the primary
