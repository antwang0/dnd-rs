...
/// Drink a Potion of Greater Healing. Same shape as the basic potion but
/// 4d4+4 — roughly twice the throughput. Self-targeted; consumes one
...
impl Action for DrinkGreaterHealingPotion {
    ...
    fn aliases(&self) -> Vec<&str> {
        vec!["greater_potion", "drink_greater"]
    }
