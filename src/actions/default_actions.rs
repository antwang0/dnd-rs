...
/// 5e Dodge: until your next turn, attackers have disadvantage and you
/// have advantage on DEX saves. Costs an Action; no targets.
pub struct Dodge {}
...
/// opportunity attacks. Costs an Action; no targets.
...
/// 5e Help: pick an ally within 5ft; they get advantage on their next
/// attack roll. Costs an Action; targets a single actor (must be ally,
/// must be adjacent).
pub struct Help {}
...
impl Action for Help {
    ...
    fn side_effects(
        ...
        vec![Box::new(crate::engine::side_effects::SetHelped {
            helper_id: caster_id,
            target_id,
        })]
    }
