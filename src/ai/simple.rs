...
fn try_support_heal(
    ...
    // Healing actions only — `is_healing=true` filters out helpful but
    // non-restoring actions like Help / Bless that would otherwise
    // pre-empt a real heal on a wounded ally.
