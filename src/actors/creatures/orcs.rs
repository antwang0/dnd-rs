...
/// Brutish frontline melee. Headline ability is Aggressive (we don't yet
/// model the bonus-action sprint), so for now Orcs lean on the Greataxe's
/// heavy d12 damage die. Stats roughly MM Orc (CR 1/2): 15 HP, AC 13,
/// STR 16, DEX 12.
