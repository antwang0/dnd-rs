...
pub static SLIME_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        // Acidic ooze — its own attack does nothing to it. Lightning
        // splits it (vulnerability) per ooze tradition.
        damage_modifiers: HashMap::from([
            (DamageType::Acid, DamageModifier::Immune),
            (DamageType::Lightning, DamageModifier::Vulnerable),
        ]),
    }
});
