...
pub static SLIME_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        // Acidic ooze — immune to its own element, no nervous system to
        // poison, but cold solidifies it.
        resistances: HashSet::from([DamageType::Slashing, DamageType::Piercing]),
