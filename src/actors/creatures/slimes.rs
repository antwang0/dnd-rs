...
pub static SLIME_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        // Goopy bodies absorb piercing/slashing easily (resistance) and
        // are immune to their own acid.
        resistances: HashSet::from([DamageType::Piercing, DamageType::Slashing]),
