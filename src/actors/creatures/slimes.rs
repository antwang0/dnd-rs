...
pub static SLIME_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        // Slimes are made of acid — they're immune to it. Lightning shocks
        // them apart (vulnerable). Bludgeoning splatters but doesn't bypass.
        resistances: HashSet::new(),
        vulnerabilities: HashSet::from([DamageType::Lightning]),
        immunities: HashSet::from([DamageType::Acid, DamageType::Poison]),
    }
});
