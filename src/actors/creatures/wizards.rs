...
use crate::actions::spells::{
    ...
    PHANTASMAL_KILLER, POISON_SPRAY, POLYMORPH, POWER_WORD_KILL, POWER_WORD_STUN, RAY_OF_FROST,
    RAY_OF_SICKNESS, SCORCHING_RAY, SHATTER, SHIELD, SHOCKING_GRASP, SLEEP, SLOW, SPIKE_GROWTH,
    STINKING_CLOUD, STONESKIN, SUGGESTION, SUNBEAM, SYNAPTIC_STATIC, TELEKINESIS, TIME_STOP,
