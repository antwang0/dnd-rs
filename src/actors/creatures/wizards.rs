...
use crate::actions::spells::{
    ...
    CROWN_OF_MADNESS, DIMENSION_DOOR, DISINTEGRATE, DISPEL_MAGIC, FINGER_OF_DEATH, FIREBALL,
    FIRE_BOLT, FIRE_SHIELD, GREATER_INVISIBILITY, HASTE, HOLD_MONSTER, HYPNOTIC_PATTERN,
    ICE_STORM, INVISIBILITY, LIGHTNING_BOLT, MAGE_ARMOR, MAGIC_MISSILE, MAGIC_WEAPON,
    MASS_SUGGESTION, METEOR_SWARM, MIND_SLIVER, MIRROR_IMAGE, MISTY_STEP, PHANTASMAL_KILLER,
    POISON_SPRAY, POWER_WORD_KILL, POWER_WORD_STUN, RAY_OF_FROST, RAY_OF_SICKNESS, SCORCHING_RAY,
    SHATTER, SHIELD, SHOCKING_GRASP, SLEEP, SLOW, STINKING_CLOUD, STONESKIN, SUGGESTION, SUNBEAM,
    SYNAPTIC_STATIC, TASHAS_HIDEOUS_LAUGHTER, THUNDERWAVE, TOLL_THE_DEAD, TRUE_STRIKE,
    VAMPIRIC_TOUCH, WALL_OF_FIRE, WALL_OF_FORCE, WEB, WITCH_BOLT,
};
