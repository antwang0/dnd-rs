...
use crate::actions::spells::{
    ...
    DIMENSION_DOOR, DISINTEGRATE, DISPEL_MAGIC, DOMINATE_PERSON, EARTHQUAKE, FEAR,
    ...
    HYPNOTIC_PATTERN, ICE_STORM, INVISIBILITY, LEVITATE, LIGHTNING_BOLT, MAGE_ARMOR, MAGIC_MISSILE,
