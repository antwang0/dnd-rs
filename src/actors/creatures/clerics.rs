...
use crate::actions::spells::{
    BLESS, CURE_WOUNDS, HEALING_WORD, HOLD_PERSON, INFLICT_WOUNDS, SACRED_BURST, SACRED_FLAME,
};
...
pub static CLERIC_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        // Cleric save proficiencies: WIS / CHA (PHB).
        save_proficiencies: HashSet::from([AbilityScoreType::Wisdom, AbilityScoreType::Charisma]),
    }
});
