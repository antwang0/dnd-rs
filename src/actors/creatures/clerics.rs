...
use crate::actions::spells::{
    BLESS, CURE_WOUNDS, HEALING_WORD, HOLD_PERSON, SACRED_BURST, SACRED_FLAME, SHIELD_OF_FAITH,
};
...
pub static CLERIC_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        size: Size::Medium,
        actions,
        // 3 level-1 slots (Healing Word / Magic Missile / Bless)
        // + 2 level-2 slots (Hold Person).
