...
pub static ZOMBIE_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        // Undead: immune to poison damage, resistant to necrotic, vulnerable
        // to radiant (so Sacred Flame / Sacred Burst feel as advertised).
        damage_modifiers: HashMap::from([
            (DamageType::Poison, DamageModifier::Immune),
            (DamageType::Necrotic, DamageModifier::Resistant),
            (DamageType::Radiant, DamageModifier::Vulnerable),
        ]),
    }
});
