...
pub static ZOMBIE_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        // Undead body: necrotic energy heals/sustains them, poison
        // can't move through dead tissue, radiant energy burns extra.
        damage_mods: HashMap::from([
            (DamageType::Necrotic, DamageMod::Resistant),
            (DamageType::Poison, DamageMod::Immune),
            (DamageType::Radiant, DamageMod::Vulnerable),
        ]),
    }
});
