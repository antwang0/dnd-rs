use crate::actions::class_features::{INCORPOREAL_MOVEMENT_TAG, TURN_RESISTANCE_TAG};
...
pub static WRAITH_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        // RAW speed line: Speed 5 ft., Fly 60 ft. (hover)
        speed: 5.0,
        fly_speed: 60.0,
        hovers: true,
        strength: 6,
        ...
        features: HashSet::from([INCORPOREAL_MOVEMENT_TAG, TURN_RESISTANCE_TAG]),
        ...
        // It had been open-coded here and had drifted: Paralyzed, Petrified and Unconscious were missing, and a
        // Frightened immunity RAW does not give a wraith had been added.
