...
pub static PALADIN_TEMPLATE: LazyLock<CreatureTemplate> = LazyLock::new(|| {
    ...
    CreatureTemplate {
        ...
        // Paladin **Fighting Style: Great Weapon Fighting** (lv2 pick,
        ...
        // Divine Smite (+1d8 radiant on hit) and every smite spell prime
        // (Searing / Wrathful / Thunderous / Branding / Blinding /
        // Staggering / Banishing) — those riders roll fresh dice on hit
        // and don't share the weapon damage bundle, so the floor doesn't
        // reach them. Routed per die through
        // `EncounterInstance::roll_weapon_damage_dice`, applied to both
        // the base greatsword swing AND the crit's doubled dice.
