...
impl EncounterInstance {
    ...
    /// - `Poisoned` / `Frightened` impose disadvantage on saves we treat
    ///   as ability checks (we don't yet split save-vs-check).
    /// - `Restrained` imposes disadvantage specifically on DEX saves.
